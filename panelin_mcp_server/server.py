...
try:
    from panelin_mcp_server.server import Server
    from panelin_mcp_server.server.stdio import stdio_server
    from panelin_mcp_server.types import Tool, TextContent
    HAS_MCP_SDK = True
except ImportError:
    HAS_MCP_SDK = False
...
def main() -> None:
    ...
    if args.transport == "stdio":
        ...
        from panelin_mcp_server.server.sse import SseServerTransport
